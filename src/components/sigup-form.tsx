        ...
        <CardContent>
            ...
            <div className="grid gap-6">
              <div className="flex flex-col gap-4">
                <Button disabled={isGithubLoading} onClick={signInWithGithub} variant="outline" className="w-full">
                ...
                <Button disabled={isGoogleLoading} onClick={signInWithGoogle} variant="outline" className="w-full">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
