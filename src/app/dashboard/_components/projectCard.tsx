        ...
        <div className="space-y-4 pb-8 pl-8 pr-8">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="mt-2 space-y-2 pt-16 flex justify-center items-center text-center">
              {values?.image && values?.image?.length > 2 ? (
                <div
                  className="flex h-12 w-12 ml-4 items-center justify-center rounded-xl"
                  style={{
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl ml-4 bg-[#3E4047]">
                  <CodeXml color="white" />
                </div>
              )}
            </div>
          ...
          <div className="pl-2 pr-2">
            ...
            <div className="flex h-9 w-full items-center gap-x-3 rounded-xl border-[0.12rem] border-[#D6DFE6] bg-[#FFFFFF] pl-3">
              ...
              <p className="font-publicSans font-lg text-[11px] text-[#AEAEAE]">
                {
                   extractRepoDetails(values?.repoUrl, values.name) && extractRepoDetails(values?.repoUrl, values.name)?.length > 30
            ...
            <div className="font-600 font-publicSans flex items-center gap-x-2 text-sm text-[#AEAEAE] overflow-hidden text-ellipsis whitespace-nowrap">
              ...
              <GitBranch
                ...
                color="#AEAEAE"
              />
              <p className="overflow-hidden text-ellipsis whitespace-nowrap">{values.branch}.</p>
            </div>
          </div>
        </div>
      </div>
