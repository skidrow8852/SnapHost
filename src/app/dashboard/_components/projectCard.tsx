      ...
      <div className="h-[340px] overflow-hidden rounded-3xl border-[0.15rem] border-[#D6DFE6] bg-[#FFFFFF]">
        <div className="space-y-4 pb-8 pl-8 pr-8">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="mt-2 space-y-2 pt-16">
          ...
          <div className="pl-2 pr-2">
            ...
            <div className="font-600 font-publicSans pt-8 text-sm text-[#AEAEAE]">
              {values.commit}
            </div>
            <div className="font-600 font-publicSans flex items-center gap-x-2 text-sm text-[#AEAEAE]">
